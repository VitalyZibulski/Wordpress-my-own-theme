			...
			<div class="new-product">
					...
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="<?php echo get_the_post_thumbnail_url();?>">
								<div class="thumb-image"> <img src="<?php echo get_the_post_thumbnail_url();?>" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
				...
				<div class="col-md-7 dress-info">
					...
					<div class="span span1">
						...
						<p class="right"><?php echo get_field("price"); ?></p>
						<div class="clearfix"></div>
					</div>
					<div class="span span2">
						<p class="left">MADE IN</p>
						<p class="right"><?php echo get_field("fabric_origin"); ?></p>
						<div class="clearfix"></div>
					</div>
					<div class="span span3">
						<p class="left">COLOR</p>
						<p class="right"><?php echo get_field("made_in"); ?></p>
						<div class="clearfix"></div>
					</div>
